			...
			.addEventListener(
					...
					function(e) {
						...
						$
								.ajax({
									type : 'POST',
									url : 'admin-customer-update-avatar', // Gọi đến URL servlet của bạn
									data : formData,
									processData : false,
									contentType : false,
									success : function(response) {
										console.log('POST thành công!',
												response);
										window.location.href = 'adminInformationCustomer?customerID=${user.userID}'; // Tải lại trang sau khi upload thành công
									},
