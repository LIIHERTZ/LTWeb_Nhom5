								...
								<div class="col-lg-6">
									<div class="hero-content">
										...
										<div class="hero-btn" data-animation="fadeInUp"
											...
											</a> <a href="/FurSPS_Nhom5/products"
			...
			<div class="row">
				<div class="col-12 wow fadeInDown" data-wow-delay=".25s">
					<div class="site-heading-inline">
						...
						<a href="/FurSPS_Nhom5/products">View More <i class="fas fa-angle-double-right"></i></a>
					</div>
				</div>
			</div>
						...
						<div class="product-item">
							...
							<div class="product-content">
								<h3 class="product-title">
									<a href='<c:url value="/products?id=${item.ProductID}"/>'>${item.ProductName}</a>
								</h3>
				...
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="banner-content">
							...
							<a href="/FurSPS_Nhom5/products" class="theme-btn">Shop
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					<div class="about-right wow fadeInRight" data-wow-delay=".25s">
						...
						<a class="theme-btn mt-4">Discover More<i
