...
<main class="main">
        ...
        <div class="site-breadcrumb">
            <div class="site-breadcrumb-bg" style="background: url(/FurSPS_Nhom5/assets/img/breadcrumb/01.jpg)"></div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="/FurSPS_Nhom5/assets/img/icon/sale.svg" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="/FurSPS_Nhom5/assets/img/icon/rate.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="/FurSPS_Nhom5/assets/img/icon/employee.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="counter-box">
                            <div class="icon">
                                <img src="/FurSPS_Nhom5/assets/img/icon/award.svg" alt="">
                            </div>
                            <div class="counter-info">
                                <div class="counter-amount">
        ...
        <div class="video-area pt-100">
            <div class="container">
                ...
                <div class="video-content" style="background-image: url(/FurSPS_Nhom5/assets/img/video/01.jpg);">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                ...
                <div class="row mt-5">
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="team-img">
                                <img src="/FurSPS_Nhom5/assets/img/team/01.jpg" alt="thumb">
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".50s">
                            <div class="team-img">
                                <img src="/FurSPS_Nhom5/assets/img/team/02.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                            <div class="team-img">
                                <img src="/FurSPS_Nhom5/assets/img/team/03.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay="1s">
                            <div class="team-img">
                                <img src="/FurSPS_Nhom5/assets/img/team/04.jpg" alt="thumb">
                            </div>
                            <div class="team-content">
                                <div class="team-bio">
