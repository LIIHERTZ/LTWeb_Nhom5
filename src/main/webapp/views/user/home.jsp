...
<html>
    <main class="main">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="hero-content">
                                        <h6 class="hero-sub-title" data-animation="fadeInUp" data-delay=".25s">Welcome to FurSPS!</h6>
                ...
                <div class="category-slider owl-carousel owl-theme wow fadeInUp" data-wow-delay=".25s">
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/bedroom.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Bedroom</h4>
                                    <p>30 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/living.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Living Room</h4>
                                    <p>25 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/bathroom.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Bathroom</h4>
                                    <p>15 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/decoration.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Decoration</h4>
                                    <p>05 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/office.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Office</h4>
                                    <p>30 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/kitchen.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Kitchen</h4>
                                    <p>12 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/storage.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Storage</h4>
                                    <p>08 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/light.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Lighting</h4>
                                    <p>14 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/sofa.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Sofa</h4>
                                    <p>19 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/chair.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Chair</h4>
                                    <p>24 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/armchair.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Armchair</h4>
                                    <p>09 Items</p>
                    ...
                    <div class="category-item">
                        <a href="#">
                            <div class="category-info">
                                <div class="icon">
                                    <img src="/FurSPS_Nhom5/assets/img/icon/table.svg" alt="">
                                </div>
                                <div class="content">
                                    <h4>Table</h4>
                                    <p>16 Items</p>
                ...
                <div class="row g-4">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="banner-item">
                            <img src="/FurSPS_Nhom5/assets/img/banner/mini-banner-1.jpg" alt="">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="banner-item">
                            <img src="/FurSPS_Nhom5/assets/img/banner/mini-banner-2.jpg" alt="">
                            <div class="banner-content">
                                <p>Hot Sale</p>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="banner-item">
                            <img src="/FurSPS_Nhom5/assets/img/banner/mini-banner-3.jpg" alt="">
                            <div class="banner-content">
                                <p>Best Chair</p>
                    ...
                    <div class="product-slider owl-carousel owl-theme">
                        <div class="product-item">
                            <div class="product-img">
                                ...
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/01.png" alt=""></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                ...
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/02.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                ...
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/03.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                ...
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/04.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/05.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/06.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
        ...
        <div class="big-banner">
            <div class="container wow fadeInUp" data-wow-delay=".25s">
                <div class="banner-wrap" style="background-image: url(/FurSPS_Nhom5/assets/img/banner/big-banner.jpg);">
                    <div class="row">
                ...
                <div class="product-wrap item-big wow fadeInUp" data-wow-delay=".25s">
                    <div class="product-slider2 owl-carousel owl-theme">
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b1.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b2.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b4.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b5.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b7.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <span class="type new">New</span>
                                <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/b10.png" alt=""></a>
                                <div class="product-action-wrap">
                                    <div class="product-action">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                            data-tooltip="tooltip" title="Quick View"><i class="far fa-eye"></i></a>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type new">New</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/14.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type hot">Hot</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/07.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type oos">Out Of Stock</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/24.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type discount">10% Off</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/15.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/09.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type new">New</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/10.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type hot">Hot</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/11.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type oos">Out Of Stock</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/12.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type discount">10% Off</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/13.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/16.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type new">New</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/17.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type hot">Hot</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/18.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type oos">Out Of Stock</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/19.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type discount">10% Off</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/20.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/21.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type new">New</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/22.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type hot">Hot</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/23.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <span class="type discount">10% Off</span>
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/25.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                            ...
                            <div class="col-md-6 col-lg-4 col-xl">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/26.png" alt=""></a>
                                        <div class="product-action-wrap">
                                            <div class="product-action">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#quickview"
                                                    data-bs-placement="top" data-tooltip="tooltip"
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-left wow fadeInLeft" data-wow-delay=".25s">
                            <div class="about-img">
                                <img class="img-1" src="/FurSPS_Nhom5/assets/img/about/01.jpg" alt="">
                                <img class="img-2" src="/FurSPS_Nhom5/assets/img/about/02.jpg" alt="">
                                <img class="img-3" src="/FurSPS_Nhom5/assets/img/about/03.jpg" alt="">
                            </div>
                    ...
                    <div class="deal-slider owl-carousel owl-theme">
                        <div class="deal-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="deal-img">
                                        <img src="/FurSPS_Nhom5/assets/img/product/b7.png" alt="">
                        ...
                        <div class="deal-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="deal-img">
                                        <img src="/FurSPS_Nhom5/assets/img/product/b2.png" alt="">
                                        <div class="deal-discount">
                                            <span>45%</span>
                                            <span>off</span>
                                        </div>
                        ...
                        <div class="deal-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="deal-img">
                                        <img src="/FurSPS_Nhom5/assets/img/product/b10.png" alt="">
                                        <div class="deal-discount">
                                            <span>45%</span>
                                            <span>off</span>
                                        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="product-list-box">
                            ...
                            <div class="product-list-item">
                                <div class="product-list-img">
                                    <a href="shop-single.html"><img src="/FurSPS_Nhom5/assets/img/product/08.png" alt="#"></a>
                                </div>
                                <div class="product-list-content">
                                    <h4><a href="shop-single.html">Simple Denim Chair</a></h4>
                                    <div class="product-list-rate">
            ...
            <div class="container wow fadeInUp" data-wow-delay=".25s">
                ...
                <div class="brand-slider owl-carousel owl-theme">
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/01.png" alt="">
                    </div>
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/02.png" alt="">
                    </div>
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/03.png" alt="">
                    </div>
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/04.png" alt="">
                    </div>
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/05.png" alt="">
                    </div>
                    <div class="brand-item">
                        <img src="/FurSPS_Nhom5/assets/img/brand/06.png" alt="">
                    </div>
                </div>
                <div class="text-center">
                ...
                <div class="row g-4 popup-gallery">
                            ...
                            <div class="gallery-img">
                                <div class="gallery-img-item gallery-item-1">
                                    ...
                                    <div class="gallery-img-content">
                                        <img src="/FurSPS_Nhom5/assets/img/product/16.png" alt="">
                                ...
                                <img class="main-img" src="/FurSPS_Nhom5/assets/img/gallery/01.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="gallery-item wow fadeInDown" data-wow-delay=".25s">
                            <div class="gallery-img">
                                <img src="/FurSPS_Nhom5/assets/img/gallery/02.jpg" alt="">
                                <a class="popup-img gallery-link" href="/FurSPS_Nhom5/assets/img/gallery/02.jpg"><i
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="gallery-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="gallery-img">
                                <img src="/FurSPS_Nhom5/assets/img/gallery/03.jpg" alt="">
                                <a class="popup-img gallery-link" href="/FurSPS_Nhom5/assets/img/gallery/03.jpg"><i
                                        class="fal fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="gallery-item wow fadeInDown" data-wow-delay=".25s">
                            <div class="gallery-img">
                                <img src="/FurSPS_Nhom5/assets/img/gallery/04.jpg" alt="">
                                <a class="popup-img gallery-link" href="/FurSPS_Nhom5/assets/img/gallery/04.jpg"><i
                                        class="fal fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="gallery-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="gallery-img">
                                <img src="/FurSPS_Nhom5/assets/img/gallery/05.jpg" alt="">
                                <a class="popup-img gallery-link" href="/FurSPS_Nhom5/assets/img/gallery/05.jpg"><i
                                        class="fal fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-lg-6">
                        <div class="gallery-item wow fadeInDown" data-wow-delay=".25s">
                            <div class="gallery-img">
                                <img src="/FurSPS_Nhom5/assets/img/gallery/06.jpg" alt="">
                                <a class="popup-img gallery-link" href="/FurSPS_Nhom5/assets/img/gallery/06.jpg"><i
                                        class="fal fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="testimonial-slider owl-carousel owl-theme wow fadeInUp" data-wow-delay=".25s">
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="/FurSPS_Nhom5/assets/img/testimonial/01.jpg" alt="">
                            </div>
                        ...
                        <div class="testimonial-quote-icon"><img src="/FurSPS_Nhom5/assets/img/icon/quote.svg" alt=""></div>
                    </div>
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="/FurSPS_Nhom5/assets/img/testimonial/02.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Gordo Novak</h4>
                                <p>Customer</p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="/FurSPS_Nhom5/assets/img/testimonial/03.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Reid E Butt</h4>
                                <p>Customer</p>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="/FurSPS_Nhom5/assets/img/testimonial/04.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-author">
                            <div class="testimonial-author-img">
                                <img src="/FurSPS_Nhom5/assets/img/testimonial/05.jpg" alt="">
                            </div>
                            <div class="testimonial-author-info">
                                <h4>Heruli Nez</h4>
                                <p>Customer</p>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="blog-item-img">
                                <img src="/FurSPS_Nhom5/assets/img/blog/01.jpg" alt="Thumb">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInDown" data-wow-delay=".25s">
                            <div class="blog-item-img">
                                <img src="/FurSPS_Nhom5/assets/img/blog/02.jpg" alt="Thumb">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="blog-item-img">
                                <img src="/FurSPS_Nhom5/assets/img/blog/03.jpg" alt="Thumb">
                ...
                <div class="instagram-slider owl-carousel owl-theme">
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/01.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/02.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/03.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/04.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/05.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/06.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                    <div class="instagram-item">
                        <div class="instagram-img">
                            <img src="/FurSPS_Nhom5/assets/img/instagram/07.jpg" alt="Thumb">
                            <a href="#"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
