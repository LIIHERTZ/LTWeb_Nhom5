							...
							<div class="col-lg-12">
								<div class="user-card">
									<div class="user-card-header">
										<h4 class="user-card-title">Sửa địa chỉ nhận hàng</h4>
									...
									<div class="user-form">
										<form action="/FurSPS_Nhom5/userUpdateAddress" method="post">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>Tên người nhận</label> <input type="text"
															class="form-control" placeholder="Tên người nhận" name="name" value="${address.name}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Số điện thoại</label> <input type="text"
															class="form-control" placeholder="Số điện thoại" name="phone" value="${address.phone}">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<label>Tỉnh thành</label> <input type="text"
															class="form-control"  list="exampleList" placeholder="Khu vực" name="city" value="${address.city}"  disabled>
													</div>
												...
												<div class="col-md-12">
													<div class="form-group">
														<label>Địa chỉ</label> <input type="text"
															class="form-control" placeholder="Địa chỉ cụ thể" name="detail" value="${address.detail}" disabled>
													</div>
												</div>
											</div>
