...
<body class="checkout-body">
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<label class="form-label">Thành phố</label> <select
																...
																class="form-control form-select" title="City" required
																oninvalid="this.setCustomValidity('Vui lòng chọn thành phố')"
																oninput="this.setCustomValidity('')">
																<option value="" disabled selected>Chọn thành
																	phố</option>
															...
															<div class="invalid-feedback">Vui lòng chọn thành
																phố.</div>
														</div>
									...
									<tbody>
										...
										<tr>
											...
											<td id="rawPriceCell"><input type="hidden"
												value="${rawPrice}" name="rawPrice" /> <fmt:formatNumber
													type="currency" value="${rawPrice}" currencyCode="VND"
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        checkoutForm.addEventListener("submit", function (event) {
            ...
            if (paymentMethod === "1") {
                // Nếu phương thức là thẻ tín dụng/thẻ ghi nợ, chuyển hướng đến VNPay
                event.preventDefault(); // Ngăn form gửi đi
                const vnpUrl = "/your-project/vnpay"; // Đường dẫn servlet xử lý VNPay
                window.location.href = vnpUrl;
            }
            // Nếu phương thức là tiền mặt (paymentMethod === "0"), form sẽ được gửi như bình thường
        });
    });
</script> -->
