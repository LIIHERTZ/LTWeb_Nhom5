			...
			<div class="col-md-3 col-lg-2 p-b-80">
				<div class="side-menu">
					<div class="p-t-55">
						...
						<ul>
							<li class="bor18"><a
								href="${pageContext.request.contextPath}/user/infoUser"
								...
								<div class="row">
									...
									<c:choose>
										<c:when test="${payment.status == 1 && payment.method==1}">
											<div class="col-md-3">
												<img style="width: 200px; height: 200px" alt="QR thanh toán"
													src="http://res.cloudinary.com/dpbczkdlt/image/upload/v1732718997/wzyfqvawbsc0tgiqfqzf.png">
											</div>
											<div class="col-md-3">
												<p class="text-muted mb-2">
													<b>NCB</b>
												</p>
												<p class="text-muted mb-2">${user.firstName} ${user.lastName} </p>
												<p class="text-muted">
													<b>Số tài khoản : </b> 9704198526191432198
												</p>
												<p class="text-muted mb-2">
													<b>Nội dung chuyển khoản : </b> FurSPS_ThanhToanDonHang_${order.orderID}
												</p>
