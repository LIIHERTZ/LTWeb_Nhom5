                ...
                <div class="row footer-widget-wrapper pt-100 pb-40">
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#d9b0b7bfb699bca1b8b4a9b5bcf7bab6b4"><i
                                            class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="2e474048416e4b564f435e424b004d4143">[email&#160;protected]</span></a></li>
                    ...
                    <div class="col-md-6 col-lg-2">
                        <div class="footer-widget-box list">
                            ...
                            <ul class="footer-list">
                                ...
                                <li><a href="shop-grid.html">Office</a></li>
                                <li><a href="shop-grid.html">Living Room</a></li>
                                <li><a href="shop-grid.html">Bathroom</a></li>
                                <li><a href="shop-grid.html">Decoration</a></li>
                                <li><a href="shop-grid.html">Kitchen</a></li>
                                <li><a href="shop-grid.html">Armchair</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-2">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box list">
                            ...
                            <p>Fameo App is now available on App Store & Google Play.</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 align-self-center">
                            <p class="copyright-text">
                                &copy; Copyright <span id="date"></span> <a href="index.html"> Fameo </a> All Rights Reserved.
                            </p>
                        </div>
                        <div class="col-12 col-lg-6 align-self-center">
